...
function onTrigger(player,npc)
    ...
    if talkStatus == 0 then
        player:PrintToPlayer("Konbanwa, I can send you to the King's Tomb - Where a turtle holding the key to artifact gear exists.")
    ...
    elseif talkStatus == 1 then
        ...
        player:setPos(24.91, 8.5, 120.2, 0, 190);
    end
end