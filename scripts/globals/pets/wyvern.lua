...
function onMobSpawn(mob)
    ...
    pet:addStatusEffect(dsp.effect.DEF_BOOST,foodPower*1.5,0,9600,0,0)
    mob:addStatusEffect(dsp.effect.STR_BOOST,foodPower,0,9600,0,0)
    mob:addStatusEffect(dsp.effect.INT_BOOST,foodPower,0,9600,0,0)
