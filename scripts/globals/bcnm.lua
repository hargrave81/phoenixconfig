...
itemid_bcnmid_map =
{
    ...
    144, {1166, 68, 1553, 76, 1130, 79, 1178, 81, 1180, 82, 1131, 77}, -- Waughroon Shrine
    146, {1552, 104, 1551, 105, 1553, 107, 1131, 108}, -- Balgas Dias
...
function TradeBCNM(player, zone, trade, npc)
    ...
    if (id == -1) then -- no valid BCNMs with this item
        ...
        player:PrintToPlayer("No valid BCNMs with this item. "..id)
        return false
