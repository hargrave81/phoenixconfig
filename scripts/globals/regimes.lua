        ...
        zone =
        {
            ...
            [dsp.zone.RUAUN_GARDENS] =
            {
                ...
                page =
                {
                    ...
                    { 8,3,0,0,73,78,3100,143},
                    {11,0,0,0,75,78,3200,144},
                    { 2,2,2,0,78,79,3300,145},
                    { 2,2,2,0,78,79,3300,146},
                },
            },
        },
    },
...
dsp.regime.bookOnEventFinish = function(player, option, regimeType)
    ...
    player:addStatusEffect(dsp.effect.AUTO_REFRESH,1,0,43200,0,3000)
    player:addStatusEffect(dsp.effect.AUTO_REGEN,1,0,43200,0,3000)
