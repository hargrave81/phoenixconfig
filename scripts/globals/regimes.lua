...
local regimeInfo = {
    ...
    [dsp.regime.type.FIELDS] =
    {
        ...
        finishOptions =
        {
            ...
            [ 21] = {act = "REPATRIATION",    cost = 10},
            [ 37] = {act = "RERAISE",         cost = 10},
            [ 53] = {act = "REGEN",           cost = 20},
            [ 69] = {act = "REFRESH",         cost = 20},
            [ 85] = {act = "PROTECT",         cost = 15},
            [101] = {act = "SHELL",           cost = 15},
            [117] = {act = "DRIED_MEAT",      cost = 25, food = true},
            [133] = {act = "SALTED_FISH",     cost = 25, food = true},
            [149] = {act = "HARD_COOKIE",     cost = 25, food = true},
            [165] = {act = "INSTANT_NOODLES", cost = 25, food = true},
            [260] = {act = "DRIED_AGARICUS",  cost = 25, food = true},
            [276] = {act = "INSTANT_RICE",    cost = 25, food = true},
        ...
        zone =
        {
            ...
            [dsp.zone.LA_THEINE_PLATEAU] =
            {
                ...
                {
                    { 3,3,0,0, 8,12, 660,  5},
                    { 3,5,0,0,11,13, 720, 69},
                    { 8,0,0,0,12,13, 780,  6},
                    { 5,3,0,0,11,14, 840, 70},
            ...
            [dsp.zone.VALKURM_DUNES] =
            {
                ...
                {
                    { 7,1,0,0,15,19, 950,  7},
                    { 6,2,0,0,15,22, 1000,  8},
                    { 5,3,0,0,18,23, 1050,  9},
                    { 4,4,0,0,20,23, 1100, 10},
            ...
            [dsp.zone.JUGNER_FOREST] =
            {
                ...
                page =
                {
                    { 8,2,0,0,15,18, 960, 58},
                    { 9,0,0,0,21,22, 1080, 11},
                    { 8,1,0,0,21,23, 1140, 12},
                    { 7,2,0,0,22,25, 1200, 13},
            ...
            [dsp.zone.BATALLIA_DOWNS] =
            {
                ...
                page =
                {
                    { 5,2,0,0,23,26, 1260, 72},
                    { 5,2,0,0,23,28, 1300, 73},
                    { 4,3,0,0,25,28, 1340, 15},
                    { 5,2,2,0,26,32, 1400, 74},
            ...
            [dsp.zone.ROLANBERRY_FIELDS] =
            {
                ...
                page =
                {
                    { 5,2,0,0,25,26, 1340, 85},
                    { 4,3,0,0,25,28, 1380, 25},
                    { 6,2,0,0,26,32, 1420, 86},
                    { 6,2,0,0,27,33, 1480, 87},
            ...
            [dsp.zone.BEAUCEDINE_GLACIER] =
            {
                ...
                page =
                {
                    { 9,2,0,0,34,38, 1620, 46},
                    { 8,3,0,0,34,39, 1710, 47},
                    { 7,4,0,0,37,42, 1800, 48},
                    { 6,4,1,0,37,43, 1890, 49},
            ...
            [dsp.zone.XARCABARD] =
            {
                ...
                page =
                {
                    { 9,3,0,0,42,46, 1800, 51},
                    { 8,4,0,0,42,45, 1900, 52},
                    { 7,4,1,0,42,48,2000, 53},
                    { 6,4,2,0,42,48,2100, 54},
            ...
            [dsp.zone.CAPE_TERIGGAN] =
            {
                ...
                page =
                {
                    { 4,4,0,0,62,66,2600,104},
                    { 4,5,0,0,64,68,2700,105},
                    { 4,5,0,0,64,69,2800,106},
                    { 7,3,0,0,66,74,2900,107},
            ...
            [dsp.zone.EASTERN_ALTEPA_DESERT] =
            {
                ...
                page =
                {
                    {10,0,0,0,30,34, 1600,109},
                    { 3,1,7,0,35,40, 1660,110},
                    { 3,1,7,0,35,44, 1700,111},
                    { 5,2,2,1,44,49, 1900,112},
            ...
            [dsp.zone.MERIPHATAUD_MOUNTAINS] =
            {
                ...
                page =
                {
                    { 9,0,0,0,20,21, 1200, 36},
                    { 8,1,0,0,20,22, 1300, 37},
                    { 7,2,0,0,21,23, 1400, 38},
                    { 6,3,0,0,22,25, 1500, 39},
            ...
            [dsp.zone.SAUROMUGUE_CHAMPAIGN] =
            {
                ...
                page =
                {
                    { 4,3,0,0,25,28, 1400, 40},
                    { 4,4,0,0,26,32, 1600, 97},
                    { 2,5,0,0,26,34, 1700, 98},
                    { 3,5,0,0,27,33, 1800, 99},
            ...
            [dsp.zone.THE_SANCTUARY_OF_ZITAH] =
            {
                ...
                page =
                {
                    { 7,2,0,0,40,44, 1900,114},
                    { 7,3,0,0,41,46, 1940,115},
                    { 7,3,0,0,41,46, 2000,116},
                    { 7,3,0,0,42,47,2100,117},
            ...
            [dsp.zone.ROMAEVE] =
            {
                ...
                page =
                {
                    { 3,3,0,0,60,65,2600,119},
                    { 7,0,0,0,64,69,2750,120},
                    { 7,0,0,0,65,69,2800,121},
                    { 6,1,0,0,78,82,3000,122},
            ...
            [dsp.zone.WESTERN_ALTEPA_DESERT] =
            {
                ...
                page =
                {
                    { 7,3,0,0,40,45, 1850,134},
                    { 5,1,4,0,44,49, 2000,135},
                    {10,1,0,0,47,53,2100,136},
                    { 2,8,0,0,51,56,2200,137},
            ...
            [dsp.zone.QUFIM_ISLAND] =
            {
                ...
                page =
                {
                    { 9,1,0,0,26,29, 1300, 41},
                    { 8,2,0,0,26,29, 1400, 42},
                    { 7,3,0,0,28,29, 1500, 43},
                    { 6,4,0,0,28,30, 1600, 44},
            ...
            [dsp.zone.BEHEMOTHS_DOMINION] =
            {
                ...
                page =
                {
                    { 3,2,0,0,41,44, 2400,101},
                    { 3,2,0,0,41,46, 2800,102},
                    { 3,2,0,0,43,47, 3300,103},
                },
            },
            [dsp.zone.VALLEY_OF_SORROWS] =
            {
                ...
                page =
                {
                    { 5,2,0,0,66,72,2440,139},
                    { 5,1,0,0,66,74,2520,140},
            ...
            [dsp.zone.RUAUN_GARDENS] =
            {
                ...
                page =
                {
                    { 8,3,0,0,72,76,3000,142},
                    { 8,3,0,0,73,78,3400,143},
                    {11,0,0,0,75,78,3500,144},
                    { 2,2,2,0,78,79,4000,145},
                    { 2,2,2,0,78,79,4000,146},
                },
            },
        },
    },
    ...
    [dsp.regime.type.GROUNDS] =
    {
        ...
        {
            [  3] = {act = "CANCEL_REGIME",   cost =  0},
            [ 20] = {act = "REPATRIATION",    cost = 10},
            [ 36] = {act = "CIRCUMSPECTION",  cost =  5},
            [ 52] = {act = "HOMING_INSTINCT", cost = 10},
            ...
            [196] = {act = "DRIED_MEAT",      cost = 25, food = true},
            [212] = {act = "SALTED_FISH",     cost = 25, food = true},
            [228] = {act = "HARD_COOKIE",     cost = 25, food = true},
            [244] = {act = "INSTANT_NOODLES", cost = 25, food = true},
            [260] = {act = "DRIED_AGARICUS",  cost = 25, food = true},
            [276] = {act = "INSTANT_RICE",    cost = 25, food = true},
        ...
        zone =
        {
            [dsp.zone.THE_BOYAHDA_TREE] =
            {
                ...
                page =
                {
                    ...
                    { 4,3,0,0, 72, 78,2700,724},
                    { 3,3,0,0, 74, 78,3040,725},
            ...
            [dsp.zone.THE_SHRINE_OF_RUAVITAU] =
            {
                ...
                page =
                {
                    {10,0,0,0, 71, 71,3070,749},
                    { 6,0,0,0, 71, 74,3280,750},
                    { 7,0,0,0, 75, 80,3830,751},
                    { 7,0,0,0, 77, 82,4150,752},
                    { 7,0,0,0, 79, 82,4050,753},
                    { 7,0,0,0, 81, 84,4290,754},
                },
            },
            ...
            [dsp.zone.KING_RANPERRES_TOMB] =
            {
                ...
                page =
                {
                    ...
                    { 6,1,0,0, 78, 80,3020,636},
                    { 5,2,0,0, 77, 80,3090,637},
            ...
            [dsp.zone.CRAWLERS_NEST] =
            {
                ...
                page =
                {
                    { 3,3,0,0, 40, 44,1660,687},
                    { 3,3,0,0, 45, 49,1830,688},
                    { 3,3,0,0, 49, 52,2080,689},
                    { 4,2,0,0, 50, 54,2200,690},
                    { 2,2,2,0, 53, 58,2440,691},
                    { 3,3,0,0, 59, 63,2870,692},
                    { 4,3,0,0, 91, 93,5090,693},
                    { 4,3,0,0, 92, 96,6020,694},
                },
            },
            ...
            [dsp.zone.GARLAIGE_CITADEL] =
            {
                ...
                page =
                {
                    { 4,2,0,0, 40, 43,1960,703},
                    { 4,2,0,0, 40, 44,1960,704},
                    { 2,4,0,0, 46, 49,2040,705},
                    { 4,2,0,0, 51, 55,2310,706},
                    { 3,3,0,0, 52, 58,2530,707},
                    { 2,2,1,0, 59, 62,2870,708},
                    { 5,2,0,0, 91, 96,4040,709},
                    { 4,3,0,0, 92, 96,4120,710},
                },
            },
            [dsp.zone.FEIYIN] =
            {
            ...
            [dsp.zone.LABYRINTH_OF_ONZOZO] =
            {
                ...
                page =
                {
                    ...
                    { 3,2,0,0, 55, 59,2130,774},
                    { 4,1,0,0, 70, 74,4350,775},
