...
function onTrigger(player,target)
    ...
    if targ:getMainJob() == xi.job.COR then
    ...
    if targ:getMainJob() == xi.job.WHM then
        learnSpell(targ,1)  -- cure
    ...
    if targ:getMainJob() == xi.job.RDM then
    ...
    if targ:getMainJob() == xi.job.SCH then
        learnSpell(targ,159)  -- stone
        learnSpell(targ,160)  -- stone II
    ...
    if targ:getMainJob() == xi.job.BRD then
    ...
    if targ:getMainJob() == xi.job.SMN then
        learnSpell(targ,288) -- fire spirit
        learnSpell(targ,306) -- alexander
    end
    if targ:getMainJob() == xi.job.PLD then
        learnSpell(targ,1)  -- cures
        learnSpell(targ,2)  -- cure 2
        learnSpell(targ,3)  -- cure 3
        learnSpell(targ,12) -- raise
    ...
    if targ:getMainJob() == xi.job.DRK then
        learnSpell(targ,159)  -- stone
        learnSpell(targ,160)  -- stone II        
    ...
    if targ:getMainJob() == xi.job.BLU then
    ...
    if targ:getMainJob() == xi.job.NIN then
