        ...
        zone =
        {
            ...
            [xi.zone.NEWTON_MOVALPOLOS] =
            {
                drops =
                {
                    {1660,  640}, -- Copper Ore
                    {1100,  641}, -- Tin Ore
                    {  90, 2765}, -- Fools Gold Ore
                    {1790, 1654}, -- Igneous Rock
                    {1450,  736}, -- Silver Ore
                    { 140,  678}, -- Aluminum Ore
                    {1720,  643}, -- Iron Ore
                    { 170,  645}, -- Darksteel Ore
                    { 210,  644}, -- Mythril Ore
                    { 180,  737}, -- Gold Ore
                    { 340,  738}, -- Platium Ore
                    {  70,  769}, -- Colored Rock
            ...
            [xi.zone.MOUNT_ZHAYOLM] =
            {
                drops =
                {
                    ...
                    {1340,  928}, -- Bomb Ash
                    { 460, 1469}, -- Wootz ore
                    { 450, 1625}, -- Moblin Helm
                    { 350, 1631}, -- Moblin Armor
                    { 380, 2160}, -- Troll Pauldron
                    { 450, 2161}, -- Troll Vambrace
                    { 330, 1638}, -- Moblin Mask
                    { 410,  902}, -- Demon Horn
                    { 590,  646}, -- Adaman Ore
                    { 480,  685}, -- Khroma Ore
                    { 370,  647}, -- Molybdenum Ore
                    { 260,  740}, -- Phrygian Ore
                },
                points =
                {
            ...
            [xi.zone.HALVUNG] =
            {
                drops =
                {
                    {1410, 2417}, -- Aht Urhgan Brass
                    {1000,  928}, -- Bomb Ash
                    {1120,  768}, -- Flint Stone
                    { 290,  737}, -- Gold Ore
                    { 490, 756}, -- durium Ore
                    { 840, 1155}, -- Iron Sand
                    { 190, 2228}, -- Luminium Ore
            ...
            [xi.zone.ZERUHN_MINES] =
            {
                drops =
                {
                    ...
                    { 380,   736}, -- Silver Ore
                    { 200,   645}, -- Darksteel Ore
                    { 100, 3892}, -- fulgent ore
                },
                points =
                {
...
function pickItem(player, info)
    ...
    -- if we picked a colored ore, change it to the day's element
    if item == 1255 then
        item = eores[VanadielDayElement() + 1]
    end
    return item
end
...
xi.helm.onTrade = function(player, npc, trade, helmType, csid)
    ...
    if trade:hasItemQty(info.tool, 1) and trade:getItemCount() == 1 then
        ...
        if
            ...
            player:getQuestStatus(AHT_URHGAN,xi.quest.id.ahtUrhgan.VANISHING_ACT) == QUEST_ACCEPTED and
