...
{
    [xi.job.WAR] = {16534,20674,11009,15456},       -- onion sword
    [xi.job.MNK] = {13184,20514,11009,15456},       -- white belt
    [xi.job.WHM] = {17068, 4608,20573,11009,13216}, -- onion rod, scroll of cure
    [xi.job.BLM] = {17104, 4607,20573,11009,13216}, -- onion staff, scroll of stone
    [xi.job.RDM] = {16482, 4606,20674,11009,13216}, -- onion dagger, scroll of dia
    [xi.job.THF] = {16483,20573,11009,15456},       -- onion knife
}
...
local function CharCreate(player)
    ...
    player:completeQuest(SANDORIA,xi.quest.id.sandoria.GROWING_FLOWERS);    
    player:moghouseFlag(1);
    player:completeQuest(BASTOK,xi.quest.id.bastok.A_LADY_S_HEART);
    player:moghouseFlag(2);
    player:completeQuest(WINDURST,xi.quest.id.windurst.FLOWER_CHILD);
    player:moghouseFlag(4);
    player:completeQuest(JEUNO,xi.quest.id.jeuno.PRETTY_LITTLE_THINGS);
    player:moghouseFlag(8);
    player:completeQuest(AHT_URHGAN,xi.quest.id.ahtUrhgan.KEEPING_NOTES);
