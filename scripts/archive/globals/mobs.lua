    ...
    if mobChainCt > 5 then
        if math.random(1,4) > 1 then
            ...
            if chest then
                ...
                if player:getMainJob() == tpz.job.WHM or player:getMainJob() == tpz.job.BLM or player:getMainJob() == tpz.job.SCH or player:getMainJob() == tpz.job.DRK or player:getMainJob() == tpz.job.PLD or player:getMainJob() == tpz.job.BLU then
                    magicUser = true
                end
