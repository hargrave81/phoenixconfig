...
xi.magic.dayStrong           = {xi.day.FIRESDAY,              xi.day.EARTHSDAY,              xi.day.WATERSDAY,               xi.day.WINDSDAY,              xi.day.ICEDAY,               xi.day.LIGHTNINGDAY,            xi.day.LIGHTSDAY,           xi.day.DARKSDAY}
xi.magic.singleWeatherStrong = {xi.weather.HOT_SPELL,         xi.weather.DUST_STORM,         xi.weather.RAIN,                xi.weather.WIND,              xi.weather.SNOW,             xi.weather.THUNDER,             xi.weather.AURORAS,         xi.weather.GLOOM}
xi.magic.doubleWeatherStrong = {xi.weather.HEAT_WAVE,         xi.weather.SAND_STORM,         xi.weather.SQUALL,              xi.weather.GALES,             xi.weather.BLIZZARDS,        xi.weather.THUNDERSTORMS,       xi.weather.STELLAR_GLARE,   xi.weather.DARKNESS}
local elementalObiStrong      = {xi.mod.FORCE_FIRE_DWBONUS,    xi.mod.FORCE_EARTH_DWBONUS,    xi.mod.FORCE_WATER_DWBONUS,     xi.mod.FORCE_WIND_DWBONUS,    xi.mod.FORCE_ICE_DWBONUS,    xi.mod.FORCE_LIGHTNING_DWBONUS, xi.mod.FORCE_LIGHT_DWBONUS, xi.mod.FORCE_DARK_DWBONUS}
local spellAcc                = {xi.mod.FIREACC,               xi.mod.EARTHACC,               xi.mod.WATERACC,                xi.mod.WINDACC,               xi.mod.ICEACC,               xi.mod.THUNDERACC,              xi.mod.LIGHTACC,            xi.mod.DARKACC}
local strongAffinityDmg       = {xi.mod.FIRE_AFFINITY_DMG,     xi.mod.EARTH_AFFINITY_DMG,     xi.mod.WATER_AFFINITY_DMG,      xi.mod.WIND_AFFINITY_DMG,     xi.mod.ICE_AFFINITY_DMG,     xi.mod.THUNDER_AFFINITY_DMG,    xi.mod.LIGHT_AFFINITY_DMG,  xi.mod.DARK_AFFINITY_DMG}
local strongAffinityAcc       = {xi.mod.FIRE_AFFINITY_ACC,     xi.mod.EARTH_AFFINITY_ACC,     xi.mod.WATER_AFFINITY_ACC,      xi.mod.WIND_AFFINITY_ACC,     xi.mod.ICE_AFFINITY_ACC,     xi.mod.THUNDER_AFFINITY_ACC,    xi.mod.LIGHT_AFFINITY_ACC,  xi.mod.DARK_AFFINITY_ACC}
xi.magic.resistMod           = {xi.mod.FIRERES,               xi.mod.EARTHRES,               xi.mod.WATERRES,                xi.mod.WINDRES,               xi.mod.ICERES,               xi.mod.THUNDERRES,              xi.mod.LIGHTRES,            xi.mod.DARKRES}
xi.magic.defenseMod          = {xi.mod.FIREDEF,               xi.mod.EARTHDEF,               xi.mod.WATERDEF,                xi.mod.WINDDEF,               xi.mod.ICEDEF,               xi.mod.THUNDERDEF,              xi.mod.LIGHTDEF,            xi.mod.DARKDEF}
xi.magic.absorbMod           = {xi.mod.FIRE_ABSORB,           xi.mod.EARTH_ABSORB,           xi.mod.WATER_ABSORB,            xi.mod.WIND_ABSORB,           xi.mod.ICE_ABSORB,           xi.mod.LTNG_ABSORB,             xi.mod.LIGHT_ABSORB,        xi.mod.DARK_ABSORB}
local nullMod                 = {xi.mod.FIRE_NULL,             xi.mod.EARTH_NULL,             xi.mod.WATER_NULL,              xi.mod.WIND_NULL,             xi.mod.ICE_NULL,             xi.mod.LTNG_NULL,               xi.mod.LIGHT_NULL,          xi.mod.DARK_NULL}
local blmMerit                = {xi.merit.FIRE_MAGIC_POTENCY,  xi.merit.EARTH_MAGIC_POTENCY,  xi.merit.WATER_MAGIC_POTENCY,   xi.merit.WIND_MAGIC_POTENCY,  xi.merit.ICE_MAGIC_POTENCY,  xi.merit.LIGHTNING_MAGIC_POTENCY}
local rdmMerit                = {xi.merit.FIRE_MAGIC_ACCURACY, xi.merit.EARTH_MAGIC_ACCURACY, xi.merit.WATER_MAGIC_ACCURACY,  xi.merit.WIND_MAGIC_ACCURACY, xi.merit.ICE_MAGIC_ACCURACY, xi.merit.LIGHTNING_MAGIC_ACCURACY}
xi.magic.barSpell            = {xi.effect.BARFIRE,            xi.effect.BARSTONE,            xi.effect.BARWATER,             xi.effect.BARAERO,            xi.effect.BARBLIZZARD,       xi.effect.BARTHUNDER}

xi.magic.dayWeak             = {xi.day.WATERSDAY,             xi.day.WINDSDAY,               xi.day.LIGHTNINGDAY,            xi.day.ICEDAY,                xi.day.FIRESDAY,             xi.day.EARTHSDAY,               xi.day.DARKSDAY,            xi.day.LIGHTSDAY}
xi.magic.singleWeatherWeak   = {xi.weather.RAIN,              xi.weather.WIND,               xi.weather.THUNDER,             xi.weather.SNOW,              xi.weather.HOT_SPELL,        xi.weather.DUST_STORM,          xi.weather.GLOOM,           xi.weather.AURORAS}
xi.magic.doubleWeatherWeak   = {xi.weather.SQUALL,            xi.weather.GALES,              xi.weather.THUNDERSTORMS,       xi.weather.BLIZZARDS,         xi.weather.HEAT_WAVE,        xi.weather.SAND_STORM,          xi.weather.DARKNESS,        xi.weather.STELLAR_GLARE}
local elementalObiWeak        = {xi.mod.FORCE_WATER_DWBONUS,   xi.mod.FORCE_WIND_DWBONUS,     xi.mod.FORCE_LIGHTNING_DWBONUS, xi.mod.FORCE_ICE_DWBONUS,     xi.mod.FORCE_FIRE_DWBONUS,   xi.mod.FORCE_EARTH_DWBONUS,     xi.mod.FORCE_DARK_DWBONUS,  xi.mod.FORCE_LIGHT_DWBONUS}
...
function doEnspell(caster, target, spell, effect)
    if effect == xi.effect.BLOOD_WEAPON then
...
function getCureFinal(caster, spell, basecure, minCure, isBlueMagic)
    ...
    if (dayElement == xi.magic.dayStrong[ele]) then
        if (math.random() < 0.33 or caster:getMod(elementalObiStrong[ele]) >= 1) then
            dayWeatherBonus = dayWeatherBonus + 0.10
        end
...
function addBonusesAbility(caster, ele, target, dmg, params)
    ...
    local mab = 1
    local mdefBarBonus = 0
    if (ele > 0 and ele <= 6 and target:hasStatusEffect(xi.magic.barSpell[ele])) then -- bar- spell magic defense bonus
        mdefBarBonus = target:getStatusEffect(xi.magic.barSpell[ele]):getSubPower()
    end
...
function doElementalNuke(caster, spell, target, spellParams)
    ...
    local mod = xi.mod.NONE
    if ele == xi.magic.element.FIRE then
        mod = xi.mod.FIRERES
    elseif ele == xi.magic.element.EARTH then
        mod = xi.mod.EARTHRES
    elseif ele == xi.magic.element.WATER then
        mod = xi.mod.WATERRES
    elseif ele == xi.magic.element.WIND then
        mod = xi.mod.WINDRES
    elseif ele == xi.magic.element.ICE then
        mod = xi.mod.ICERES
    elseif ele == xi.magic.element.LIGHTNING then
        mod = xi.mod.THUNDERRES
    elseif ele == xi.magic.element.LIGHT then
        mod = xi.mod.LIGHTRES
    elseif ele == xi.magic.element.DARK then
        mod = xi.mod.DARKRES
    end
    if mod ~= xi.mod.NONE then
