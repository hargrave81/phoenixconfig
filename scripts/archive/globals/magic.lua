...
function doElementalNuke(caster, spell, target, spellParams)
    ...
    local mod = tpz.mod.NONE
    if ele == tpz.magic.element.FIRE then
        mod = tpz.mod.FIRERES
    elseif ele == tpz.magic.element.EARTH then
        mod = tpz.mod.EARTHRES
    elseif ele == tpz.magic.element.WATER then
        mod = tpz.mod.WATERRES
    elseif ele == tpz.magic.element.WIND then
        mod = tpz.mod.WINDRES
    elseif ele == tpz.magic.element.ICE then
        mod = tpz.mod.ICERES
    elseif ele == tpz.magic.element.LIGHTNING then
        mod = tpz.mod.THUNDERRES
    elseif ele == tpz.magic.element.LIGHT then
        mod = tpz.mod.LIGHTRES
    elseif ele == tpz.magic.element.DARK then
        mod = tpz.mod.DARKRES
    end
    if mod ~= tpz.mod.NONE then
