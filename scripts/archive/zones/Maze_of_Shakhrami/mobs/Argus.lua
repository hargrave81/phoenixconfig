...
function onMobDespawn(mob)
    --if math.random(2) == 1 then
        ...
        GetMobByID(ID.mob.ARGUS):setRespawnTime(math.random(64800, 86400)) -- 18-30 hours
    --else
        --DisallowRespawn(ID.mob.ARGUS, true)
        --DisallowRespawn(ID.mob.LEECH_KING, false)
        --UpdateNMSpawnPoint(ID.mob.LEECH_KING)
        --GetMobByID(ID.mob.LEECH_KING):setRespawnTime(math.random(64800, 86400)) -- 18-30 hours
    --end
end
