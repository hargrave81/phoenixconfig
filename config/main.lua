...
xi.settings.main =
{
    ...
    SERVER_NAME = "Elemental",

    SERVER_MESSAGE =
        "Please visit https://github.com/AirSkyBoat/AirSkyBoat for the latest information on the root project.\n" ..
        "This server is limited to LV75 content.  Please be kind!",
    ...
    ELEMENTAL_POWER = 1.100, -- Multiplies damage dealt by Elemental and non-drain Dark Magic.
    DIVINE_POWER    = 1.800, -- Multiplies damage dealt by Divine Magic.
    ...
    BESIEGED_ENABLED                          = true,  -- Global toggle to enable / disable the besieged feature
    ...
    ASSAULT_MINIMUM     = 2,                -- Minimum amount of people needed to start an assault mission. TOAU era is 3, Default is 1.
    ...
    ENABLE_DARK_RIDER            = true, -- If true, enables Dark Rider to spawn as in era.

    -- Synergy
    ENABLE_SYNERGY = 0, -- Default to off as Synergy is not coded

    -- Adventuring Fellows
    ENABLE_ADVENTURING_FELLOWS         = false, -- Enable or disable the ability to quest and call Adventuring Fellows
    ALLOW_ADVENTURING_FELLOW_KATANA_DW = false, -- Enable or disable dual wielding katanas for Adventuring Fellows
