...
struct map_config_t
{
    ...
    bool   fov_allow_alliance;        // Allow alliances
    ...
    bool craft_day_matters;           // craft day matters
    bool craft_direction_matters;     // direction matters
    bool craft_moonphase_matters;     // moon phase matters
